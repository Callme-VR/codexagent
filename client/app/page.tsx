    ...
    <div className="flex min-h-screen items-center justify-center bg-background font-sans">
      <div className="w-full max-w-md px-4">
        <div className="space-y-8">
            ...
            <div className="flex items-center justify-center mb-6">
              <div className="relative">
                <Image
                  ...
                  width={120}
                  height={120}
                  className="rounded-full border-dashed border-s-zinc-600 object-cover"
                />
          ...
          hover:bg-red-600 bg-red-500 text-white font-semibold rounded-lg transition-colors"
          >
            SignOut
          </Button>
          ...
          <div className="flex items-center gap-3">
            <div className="flex-1 h-px border-t border-dashed border-zinc-700">
              ...
              <div className="flex-1 px border-t border-dashed border-x-zinc-700"></div>
            </div>
          </div>
        </div>
      </div>
